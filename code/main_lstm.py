...
if __name__ == '__main__':
    ...
    rnn_log_path = 'lstm_results/lstm_log_24.csv'
    ...
    for i in range(10):
        ...
        if min_rnn_loss > rnn_loss:
            ...
            min_rnn_model = rnn
            print(min_rnn_loss)
            save_loss('lstm_results/pickles/lstm_24_'+'.pkl', min_rnn_losses)
            save_net('lstm_results/net/lstm_24_'+'.pt', min_rnn_model)
