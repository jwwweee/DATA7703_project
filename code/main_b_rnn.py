...
if __name__ == '__main__':
    ...
    for K in Ks:
        ...
        # write header
        bagging_rnn_log_path = 'b_rnn_results/K_'+str(K)+'_bagging_rnn_log_24.csv'
        ...
        for i in range(30):
            ...
            if min_b_rnn_loss > b_rnn_loss:
                ...
                save_loss('b_rnn_results/pickles/K_'+str(K)+'_b_rnn_'+'.pkl', min_bagging_rnn_losses)
                save_net('b_rnn_results/net/K_'+str(K)+'_b_rnn_'+'.pt', min_bagging_rnn_model)
